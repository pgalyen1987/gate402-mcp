...
| `gate402_compute` | Metered GPU/CPU for a container job, with a signed execution receipt. **Not available yet**: answers 503 until a compute provider is connected | per-second |
